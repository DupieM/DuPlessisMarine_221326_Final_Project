<?php
    ...
    if ($SuperUser_Global == true) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo '<a class="btn" href="list_view3.php?id=' . $row['ID'] . '" role="button" style="margin-top: 7px;margin-left: 20px;background-color: #215273;color: #55C595;font-size: large;font-weight: bold;">Update</a>';//EDIT
