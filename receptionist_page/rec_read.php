<?php
    ...
    if ($SuperUser_Global == true) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo '<a class="btn" href="?id=' . $row['ID'] . '" role="button" style="margin-top: -41px;margin-left: 180px;background-color: #215273;color: #55C595;font-size: large;font-weight: bold;">Ban</a>';//BAN
            echo '</form>';
            echo '</div>';
            echo '</br>';
            echo '</br>';
