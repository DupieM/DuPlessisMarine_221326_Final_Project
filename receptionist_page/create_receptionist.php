...
<html lang="en">
    ...
    <body style="background-color:#ECFFFD;">
        ...
        <a href="..\appointment_page\appointment.php" style="margin-left: 0px;"><img src="..\img\dv logo.png" alt="logo" height="79" style="padding: 5px;"></a>
            <a href="..\docter_page\docters.phpdocters.php" style="margin-left: 420px;font-size: 18pt;font-weight: 500;color: #87E4DA;text-decoration-line: none;"><img src="..\img\icon_doc.png" alt="doc" height="51">Doctors</a>
        ...
        <div style="background-image: url('img/create_doc_recp.png');background-repeat: no-repeat;height: 710px;">
            <div style="text-align: center;">
                <h1 style="color: #215273; font-size: 40pt; font-weight: 400;">Add Receptionist</h1>
            </div>
            ...
            <div style="margin-top: 23px;width: 550px;height: 506px;background-color: rgba(255, 255, 255, 0.7);border: 2px solid black;margin-left: 451px;padding-right: 70px;">
                <form class="form-inline m-2" action="create3.php" method="POST">
                    ...
                    <label for="score" style="padding-left: 141px;font-size: 20pt;font-weight: 500;color: #073D51;">Rank:</label>
                    <input type="text" class="form-control m-1" id="rank" name="rank" style="width: 240px;font-size: 12pt;color: #073D51;">
                    ...
                    <button type="submit" class="btn" style="border: none;background-color: #215273;color: #FE5955;font-size: 16pt;font-weight: 600;margin-top: 12px;margin-left: 170px;">
                        Add Receptionists
                    </button>
                </form>
            </div> 
