<?php
    ...
    if ($SuperUser_Global == true) {
        ...
        if($row = $result->fetch_assoc()) {
            echo '<a class="btn" href="create_receptionist.php" role="button" style="border: none;background-color: #215273;color: #FE5955;font-size: large;font-weight: 600;">';
            echo 'Add Receptionist';
            echo '</a>';
