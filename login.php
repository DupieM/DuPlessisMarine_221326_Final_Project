    ...
    <body>
        <div style="height: 786px;background-color: #ECFFFD;width: 1440px">
            ...
            <div style="margin-top: -570px;margin-left: 200px;">
                ...
                <form class="form-inline m-2" style="width: 400px;">
                    <label for="name" style="font-weight: bold; font-size: 20pt;color: #215273;">Email:</label>
                    <input type="text" class="form-control m-2" id="name" name="name" style="width: 340px;color: #215273;border: 2px solid #215273;">
                    <label for="password" style="font-weight: bold; font-size: 20pt;color: #215273;">Password:</label>
                    <input type="text" class="form-control m-2" id="name" name="name" style="width: 340px;color: #215273;border: 2px solid #215273;">
                    <label for="conpassword" style="font-weight: bold; font-size: 20pt;color: #215273;">Confirm Password:</label>
                    <input type="text" class="form-control m-2" id="name" name="name" style="width: 340px;color: #215273;border: 2px solid #215273;">
