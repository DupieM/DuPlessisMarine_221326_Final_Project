<?php
    ...
    if ($SuperUser_Global == true) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            $patid = $row['ID'];
            $sqlA = "SELECT Day, Time FROM appointments WHERE Patients_ID = '$patid' AND Day <= curdate()";
            ...
            echo '<input type="text" class="card-text" name="idnumber" value="'.$row['Age'].'" style="border: none;font-size: large;width: 240px;background-color: lightBlue;color: #1F6C74;">';
            echo '<label for="name" style="font-weight: bold;color: #1F6C74;">Gender:</label>';
            echo '<input type="text" class="card-text" name="dateofbirth" value="'.$row['Gender'].'" style="border: none;font-size: large;width: 240px;background-color: lightBlue;color: #1F6C74;">';
            echo '<label for="name" style="font-weight: bold;color: #1F6C74;">Email:</label>';
            echo '<input type="text" class="card-text" name="gender" value="'.$row['Email'].'" style="border: none;font-size: large;width: 240px;background-color: lightBlue;color: #1F6C74;">';
            ...
            echo '<label for="name" style="font-weight: bold;color: #1F6C74;">Previous Appointments:</label>';

            while ($rowA = $resultA->fetch_assoc()) {
                $date2=date_create($rowA['Day']);
                $time2=date_create($rowA['Time']);

                echo '<input type="text" class="card-text" name="role" value="' . date_format($date2,"d/m/Y") . ' ' . date_format($time2,"H:i") . '" style="border: none;font-size: large;width: 170px;background-color: lightBlue;color: #1F6C74;">';
            }
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo '<form class="form-inline m-2" action="update.php" method="POST" style="width: 240px;">';
            echo '<label for="name" style="font-weight: bold;color: #1F6C74;">Name & Surname:</label>';
            echo '<h1 style="color: #1F6C74;font-size: large;font-weight: 400;width: 240px;">' . $row['Name'] . ' ' . $row['Surname'] . '</h1>';
            echo '<label for="name" style="font-weight: bold;color: #1F6C74;">Age:</label>';
            echo '<h1 style="color: #1F6C74;font-size: medium;width: 240px;">' . $row['Age'] . '</h1>';
            echo '<label for="name" style="font-weight: bold;color: #1F6C74;">Gender:</label>';
            echo '<h1 style="color: #1F6C74;font-size: medium;width: 240px;">' . $row['Gender'] . '</h1>';
            echo '<label for="name" style="font-weight: bold;color: #1F6C74;">Email:</label>';
            echo '<h1 style="color: #1F6C74;font-size: medium;width: 240px;">' . $row['Email'] . '</h1>';
            echo '<label for="name" style="font-weight: bold;color: #1F6C74;">Phone Number:</label>';
            ...
            while ($rowA = $resultA->fetch_assoc()) {
                ...
                echo '<h1 style="color: #1F6C74;font-size: medium;width: 140px;">' . date_format($date2,"d/m/Y") . ' ' . date_format($time2,"H:i") . '</h1>';
            }
