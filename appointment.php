...
<html lang="en">
    ...
    <body style="background-color: #ECFFFD;">
        <div class="topnav">
            ...
            <a href="docters.php" style="margin-left: 420px;font-size: 18pt;color: #87E4DA;text-decoration-line: none;"><img src="img\icon_doc.png" alt="doc" height="51">Doctors</a>
            <a href="patients.php" style="margin-left: 10px;font-size: 18pt;color: #87E4DA;text-decoration-line: none;"><img src="img\icon_pat.png" alt="pat" height="51">Patients</a>
